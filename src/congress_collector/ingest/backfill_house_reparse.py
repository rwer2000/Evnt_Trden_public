...
change added after they were first parsed: option_type/strike/expiry
(T15) and source_transaction_id (T16), and whatever the next one turns
out to be.
...
# A transaction needs re-parsing if either backfilled field it's eligible
